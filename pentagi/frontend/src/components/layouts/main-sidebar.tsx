...
const MainSidebar = () => {
    ...
    const isPyramidActive = useMatch('/pyramid');
    const isFindingsActive = useMatch('/findings');
    const isReleaseGateActive = useMatch('/release-gate');
    const isAIEvalsActive = useMatch('/ai-evals');
    const isAuditActive = useMatch('/audit');
    ...
    return (
        <Sidebar collapsible="icon">
            ...
            <SidebarContent>
                <SidebarGroup>
                    <SidebarGroupLabel>Security Testing</SidebarGroupLabel>
                    <SidebarGroupContent>
                        <SidebarMenu>
                            <SidebarMenuItem>
                                <SidebarMenuButton
                                    asChild
                                    isActive={!!isPyramidActive}
                                >
                                    <Link to="/pyramid">
                                        <ActivitySquare />
                                        Testing Pyramid
                            ...
                            <SidebarMenuItem>
                                <SidebarMenuButton
                                    asChild
                                    isActive={!!isReleaseGateActive}
                                >
                                    <Link to="/release-gate">
                                        <TriangleAlert />
                                        Release Gate
                                    </Link>
                                </SidebarMenuButton>
