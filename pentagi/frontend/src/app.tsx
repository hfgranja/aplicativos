...
const PyramidOverview = lazy(() => import('@/pages/pyramid/pyramid-overview'));
const FindingsPage = lazy(() => import('@/pages/pyramid/findings-page'));
const ReleaseGatePage = lazy(() => import('@/pages/pyramid/release-gate-page'));
const AIEvalsPage = lazy(() => import('@/pages/pyramid/ai-evals-page'));
const AuditTrailPage = lazy(() => import('@/pages/pyramid/audit-trail-page'));
